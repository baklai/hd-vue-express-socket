    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          {
            scope: 'vpn:find:one',
            comment: 'Read one vpn from database',
            default: true
          },
          {
            scope: 'vpn:find:all',
            comment: 'Read all vpns from database',
            default: true
          },
          {
            scope: 'vpn:update:one',
            comment: 'Update one vpn in database',
            default: false
          },
          {
            scope: 'vpn:remove:one',
            comment: 'Delete one vpn in database',
            default: false
          }
        ]
      },
