                    ...
                    >
                        ...
                        <div class="mt-2 md:mt-0 flex align-items-center">
                            <div class="surface-300 border-round overflow-hidden w-12rem lg:w-6rem mr-4" style="height: 8px">
                                <div class="bg-yellow-300 h-full" :style="`width: ${onCountPercentWidth(item.count, stats.count)}px`"></div>
                            </div>
                            <span class="text-yellow-500 font-medium w-6rem">{{ onCountPercent(item.count, stats.count) }} %</span>
                        </div>
                    </li>
                </ul>
            </div>
