            ...
            <div class="flex">
                ...
                <Card style="height: calc(100vh - 14rem)" class="sticky w-auto overflow-y-auto" :class="!isSidebar && 'hidden'">
                    ...
                    <template #content>
                        ...
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro architecto vero illum assumenda sunt aperiam facere. Dicta id
                        doloremque consequuntur expedita. Omnis enim similique nam quia eveniet velit blanditiis assumenda! Fugiat quisquam fugit
                        nisi. In omnis eligendi odio dolores, corporis iusto est numquam impedit, necessitatibus eius possimus. Nesciunt praesentium a
                    </template>
                    <template #footer>
