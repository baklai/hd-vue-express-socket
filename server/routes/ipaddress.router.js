...
const { findAll, findOne, searchOne, createOne, updateOne, removeOne } = require('../controllers/ipaddress.controller');
...
router.route('/:id').get(findOne).put(updateOne).delete(removeOne);

router.route('/search/:ipaddress').get(searchOne);
