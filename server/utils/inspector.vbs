POSTJSON "http://localhost:3000/inspector?field=baseboard", WMI("select SerialNumber from Win32_BaseBoard")
POSTJSON "http://localhost:3000/inspector?field=bios", WMI("select SerialNumber,Version from Win32_BIOS")
POSTJSON "http://localhost:3000/inspector?field=os", WMI("select CSName,Caption,OSArchitecture,Version from Win32_OperatingSystem")
POSTJSON "http://localhost:3000/inspector?field=cpu", WMI("select Name,CurrentClockSpeed,NumberOfCores,NumberOfLogicalProcessors,Architecture,Manufacturer from Win32_Processor")
POSTJSON "http://localhost:3000/inspector?field=memorychip", WMI("select Capacity,Speed,Manufacturer,Description from Win32_PhysicalMemory")
POSTJSON "http://localhost:3000/inspector?field=diskdrive", WMI("select Description,Caption,Size,SerialNumber,Manufacturer from Win32_DiskDrive")
POSTJSON "http://localhost:3000/inspector?field=netadapter", WMI("select NetConnectionID,AdapterType,Name,Description,Manufacturer,MACAddress from Win32_NetworkAdapter")
POSTJSON "http://localhost:3000/inspector?field=useraccount", WMI("select Name,Description,Disabled from Win32_UserAccount")
POSTJSON "http://localhost:3000/inspector?field=useradmin", WMIUsersAdmin()
POSTJSON "http://localhost:3000/inspector?field=share", WMI("select Name,Type,Path,Description from Win32_Share")
POSTJSON "http://localhost:3000/inspector?field=printer", WMI("select Name from Win32_Printer")
POSTJSON "http://localhost:3000/inspector?field=product", WMI("select Name,Vendor,Version,InstallDate from Win32_Product")
