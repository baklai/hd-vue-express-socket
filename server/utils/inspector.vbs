POSTJSON "http://localhost:3000/inspector?field=baseboard", WMI("select * from Win32_BaseBoard")
POSTJSON "http://localhost:3000/inspector?field=bios", WMI("select * from Win32_BIOS")
POSTJSON "http://localhost:3000/inspector?field=os", WMI("select * from Win32_OperatingSystem")
POSTJSON "http://localhost:3000/inspector?field=cpu", WMI("select * from Win32_Processor")
POSTJSON "http://localhost:3000/inspector?field=memorychip", WMI("select * from Win32_PhysicalMemory")
POSTJSON "http://localhost:3000/inspector?field=diskdrive", WMI("select * from Win32_DiskDrive")
POSTJSON "http://localhost:3000/inspector?field=netadapter", WMI("select * from Win32_NetworkAdapter")
POSTJSON "http://localhost:3000/inspector?field=display", WMI("select * from Win32_DesktopMonitor")
POSTJSON "http://localhost:3000/inspector?field=videoadapter", WMI("select * from Win32_VideoController")
POSTJSON "http://localhost:3000/inspector?field=sound", WMI("select * from Win32_SoundDevice")
POSTJSON "http://localhost:3000/inspector?field=useraccount", WMI("select * from Win32_UserAccount")
