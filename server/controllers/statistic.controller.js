...
const network = async (req, res, next) => {
  try {
    const [channels, companies, branches, enterprises, locations, units, vpns, statistic, barUnits, barLocations, barBranches, barEnterprises] =
      await Promise.all([
...
const sysinspector = async (req, res, next) => {
  try {
...
module.exports = { network, request, sysinspector, dashboard };
